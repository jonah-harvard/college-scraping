...
carnegie_mellon <- professors %>% filter(college == "Carnegie Mellon University")
cor.test(carnegie_mellon$difficulty, carnegie_mellon$rating)
```
...
professors %>% ggplot(aes(rating)) + geom_histogram() + facet_wrap(~ college)
professors %>% ggplot(aes(difficulty)) + geom_histogram() + facet_wrap(~ college)
```
